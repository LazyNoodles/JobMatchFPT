        ...
        public async Task<IActionResult> Create(JobViewModel jobVM)
        {
            ...
            try
            {
                ...
                if (result.IsValid)
                {
                    ...
                    ViewData[ViewBags.ANNOUNCEMENT] = "Succesfully Created";
            ...
            catch
            {
                ...
                ViewData[ViewBags.ANNOUNCEMENT] = "Failed Creating";
            }
            ...
            try
            {
                ...
                if (result.IsValid)
                {
                    ...
                    if(job != null)
                    {
                        ...
                        ViewData[ViewBags.ANNOUNCEMENT] = "Successfully Created";
                        return RedirectToAction("Create");
                    }
                }
            }
